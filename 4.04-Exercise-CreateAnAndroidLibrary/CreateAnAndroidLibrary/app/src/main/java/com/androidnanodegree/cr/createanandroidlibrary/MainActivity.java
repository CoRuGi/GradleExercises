package com.androidnanodegree.cr.createanandroidlibrary;
...
import com.androidnanodegree.cr.mylibrary.JokeActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void tellMeAJoke(View view) {
        ...
        intent.putExtra(newJoke, jokeSmith.getJoke());
